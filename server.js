...
async function callOpenAI(prompt) {
  if (!OPENAI_KEY) {
    return "AI key not configured. Set OPENAI_API_KEY on Render or locally to get real responses.";
  }
...
app.post("/api/social", (req, res) => {
  ...
  switch ((platform+"").toLowerCase()) {
    ...
    case "instagram":
    case "ig":
      // Instagram doesn't support direct share via web; provide instructions or link to profile creation
